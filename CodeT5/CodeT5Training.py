...
from transformers import T5Tokenizer,AutoTokenizer, RobertaTokenizer
...
model.save_pretrained('results/codet5_finetuned')
tokenizer.save_pretrained('results/codet5_finetuned')
